...
import {
    actionToCreateGoogleMeetUrlLink,
...
export default function TrainerDashboard() {
    ...
    useEffect(() => {
        if (result === "success-meeting") {
            toast.success("Google Meet URL created successfully!");
        } else if (result === "error-meeting") {
            toast.error("Error generating Google Meet URL. Please try again.");
        }
    ...
    async function handleCreateMeetClick() {
        setCreating(true);
        let data = await actionToCreateGoogleMeetUrlLink(setCreating);
        if(data){
            toast.success("Google Meet URL created successfully!");
        }
    }
    ...
    return (
        <div className="container">
            ...
            <div className="d-flex gap-2 pb-2">
                ...
                >
                    {creating ? "Creating…" : "Create Meeting links for today"}
                </button>
            </div>
            ...
            <div className="card shadow-sm mb-4">
                <div className="card-body">
                    ...
                    <p className="text-muted small mb-3">
                        Only classes assigned to you are shown here. When the class is ongoing, use <strong>Open Link</strong> or{" "}
